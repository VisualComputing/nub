...
/**
 * A {@link frames.input.event.MotionEvent} with two degrees-of-freedom ({@link #x()}
 * and {@link #y()}).
 */
public class MotionEvent2 extends MotionEvent {
  ...
  protected MotionEvent2(MotionEvent2 motionEvent2) {
    super(motionEvent2);
    this._x = motionEvent2._x;
    this._dx = motionEvent2._dx;
    this._y = motionEvent2._y;
    this._dy = motionEvent2._dy;
  }
