...
public class TwistHeuristic extends Heuristic{
    ...
    public void applyActions(int i) {
        ...
        Quaternion rotation;
        if(_smooth) rotation = _findTwist(j_i, j_i1, endEffector, _context.worldTarget(), _smoothAngle, _smoothAngle, _context.direction());
        else rotation = _findTwist(j_i, j_i1, endEffector, _context.worldTarget(), _maxTwistCCD, _maxTwistDirection, _context.direction());
