...
package proscene.primitives;

import proscene.primitives.constraint.Constraint;
 ...
 * {@link proscene.primitives.constraint.LocalConstraint},
...
public class Frame {
  ...
  /**
   * Returns the current {@link proscene.primitives.constraint.Constraint} applied to the
   * frame.
   * <p>
   ...
   * Use {@link proscene.core.Graph#applyTransformation(Frame)} instead.
   *
   * @see #setMatrix(Frame)
   * @see #worldMatrix()
   * @see #view()
