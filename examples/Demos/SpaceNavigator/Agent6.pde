 ...
 * 
 * This class parses space navigator input data to
 * MotionEvent6 events.
 *
...
public class Agent6 extends Agent {
  ...
  public MotionEvent6 handleFeed() {
    return new MotionEvent6(s[0]*sliderXpos.getValue(), s[1]*sliderYpos.getValue(),
                            s[2]*sliderZpos.getValue(), s[3]*sliderXrot.getValue(),
                            s[4]*sliderYrot.getValue(), s[5]*sliderZrot.getValue(),
