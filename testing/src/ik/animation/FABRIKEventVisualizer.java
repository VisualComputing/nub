...
public class FABRIKEventVisualizer extends PApplet {
    ...
    public void setup() {
        ...
        visualizer = new FABRIKVisualizer(animScene, targetRadius * 0.8f, 40, 480);
    ...
    public static void main(String[] args) {
        PApplet.main(new String[]{"ik.animation.FABRIKEventVisualizer"});
    }
}
