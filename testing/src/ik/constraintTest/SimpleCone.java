...
public class SimpleCone extends PApplet {
  ...
  public void setup() {
    ...
    BallAndSocket c2 = new BallAndSocket(radians(50), radians(80));
    c2.setRestRotation(j2.rotation().get(), Vector.cross(new Vector(0, -1, 0), j3.translation(), null), j3.translation().get());
    c2.setTwistLimits(radians(170), radians(0));
    j2.setConstraint(c2);
  ...
  public static void main(String args[]) {
    PApplet.main(new String[]{"ik.constraintTest.SimpleCone"});
  }
