...
public class HingeTest extends PApplet {
    ...
    public void setConstraint(Frame f, Vector twist, float boneLength){
    ...
    public ArrayList<Node> generateStructure(float boneLength, Vector o){
        ...
        setConstraint(current, new Vector(0,0,1),boneLength);
        ...
        setConstraint(current, new Vector(1,0,0),boneLength);
