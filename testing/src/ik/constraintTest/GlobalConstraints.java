...
public class GlobalConstraints extends PApplet {
    ...
    public void setup() {
        ...
        for(int i = 0; i < numSolvers; i++){
            ...
            structures.add(Util.generateChain(scene, numJoints, 0.3f* targetRadius, boneLength, new Vector(i * 2 * alpha * scene.radius()/(max(numSolvers - 1,1)) - alpha * scene.radius(), 0, 0), color, randRotation, randLength));
        }
