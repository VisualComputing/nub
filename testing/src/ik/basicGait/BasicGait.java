...
public class BasicGait extends PApplet{
    ...
    public void setup() {
        ...
        Solver solver = scene.setIKStructure(leftLeg.get(0));
        scene.addIKTarget(leftLeg.get(2), leftTarget);
        solver.setTIMESPERFRAME(TimesPerFrame);

        solver = scene.setIKStructure(rightLeg.get(0));
    ...
    public static void main(String args[]) {
        PApplet.main(new String[]{"ik.basicGait.BasicGait"});
    }
