...
public class SimpleSkeleton extends PApplet {
    ...
    public Node createSkeleton(Node reference){
        ...
        Joint j43 = new Joint(scene, scene.radius() * 0.01f);
        ...
        Joint j44 = new Joint(scene, scene.radius() * 0.01f);
        ...
        Joint j45 = new Joint(scene, scene.radius() * 0.01f);
        ...
        Joint j178 = new Joint(scene, scene.radius() * 0.01f);
        ...
        Joint j179 = new Joint(scene, scene.radius() * 0.01f);
        ...
        Joint j180 = new Joint(scene, scene.radius() * 0.01f);
        ...
        Joint j715 = new Joint(scene, scene.radius() * 0.01f);
        ...
        Joint j716 = new Joint(scene, scene.radius() * 0.01f);
        ...
        Joint j717 = new Joint(scene, scene.radius() * 0.01f);
