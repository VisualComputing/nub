...
public class DOFLL extends PApplet {
  String depthPath;
  ...
  public void setup() {
    ...
    // TODO remove this from Scene constructor?
    depthScene = new Scene(this, P3D, scene.eye());
  ...
  public static void main(String[] args) {
    PApplet.main(new String[]{"intellij.DOFLL"});
  }
}
