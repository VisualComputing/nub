...
public class DOF extends PApplet {
  ...
  public void setup() {
    ...
    depthScene = new Scene(createGraphics(width, height, P3D));
    depthScene.setEye(eye);
  ...
  public void draw() {
    ...
    depthShader.set("near", depthScene.near());
    depthShader.set("far", depthScene.far());
    depthScene.render();
