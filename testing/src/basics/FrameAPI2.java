...
public class FrameAPI2 extends PApplet {
  Scene scene;
  ...
  public void mouseMoved(MouseEvent event) {
    ...
    else if (scene.trackedFrame("mouse") == null)
      scene.lookAround();
    else
      scene.spin("mouse");
  }
  ...
  public class InteractiveFrame extends Frame {
    ...
    public InteractiveFrame(Scene graph, int color) {
      super(graph);
      scene = (Scene) graph();
      _c = color;
  ...
  public static void main(String args[]) {
    PApplet.main(new String[]{"basics.FrameAPI2"});
  }
}
