...
public class FrameAPI extends PApplet {
  ...
  public void setup() {
    ...
    eye = new OrbitNode3(scene, f1Color);
    eye.setRotationSensitivity(1.3f);
    scene.setEye(eye);
    ...
    f1 = new OrbitNode3(scene, f1Color);
    f1.translate(-50, -20, 30);
    f1.scale(1.3f);

    f2 = new OrbitNode3(f1, f2Color);
    f2.translate(60, -40, -30);
    f2.scale(1.2f);

    f3 = new OrbitNode3(f1, f3Color);
  ...
  void displayText() {
    ...
    textFont(font13);
    fill(f1Color);
    pos = scene.projectedCoordinates(f1.position());
    text("Frame 1", pos.x(), pos.y());
    fill(f2Color);
    pos = scene.projectedCoordinates(f2.position());
    text("Frame 2", pos.x(), pos.y());
    fill(f3Color);
    pos = scene.projectedCoordinates(f3.position());
    text("Frame 3", pos.x(), pos.y());
    fill(f4Color);
    pos = scene.projectedCoordinates(f4.position());
    text("Frame 4", pos.x(), pos.y());
    fill(f5Color);
    pos = scene.projectedCoordinates(f5.position());
